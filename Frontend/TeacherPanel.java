...
public class TeacherPanel {
	...
	private void initialize(String name) {
		...
		sl_dashboardCardPanelTeacherTop.putConstraint(SpringLayout.NORTH, welcomeMessageTeacher, 25, SpringLayout.NORTH, dashboardCardPanelTeacherTop);
		sl_dashboardCardPanelTeacherTop.putConstraint(SpringLayout.WEST, welcomeMessageTeacher, 10, SpringLayout.WEST, dashboardCardPanelTeacherTop);
		sl_dashboardCardPanelTeacherTop.putConstraint(SpringLayout.SOUTH, welcomeMessageTeacher, -22, SpringLayout.SOUTH, dashboardCardPanelTeacherTop);
		sl_dashboardCardPanelTeacherTop.putConstraint(SpringLayout.EAST, welcomeMessageTeacher, 362, SpringLayout.WEST, dashboardCardPanelTeacherTop);
