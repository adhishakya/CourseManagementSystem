...
public class LogoutPromptStudent extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LogoutPromptStudent dialog = new LogoutPromptStudent();
	 ...
	 * Create the dialog.
	 */
	public LogoutPromptStudent() {
		setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		setTitle("Logout");
		setResizable(false);
		setAlwaysOnTop(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(LogoutPromptStudent.class.getResource("/images/warning.png")));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				StudentPanel.getFrmStudentPanel().dispose();
