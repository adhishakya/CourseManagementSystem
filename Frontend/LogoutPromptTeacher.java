...
public class LogoutPromptTeacher extends JDialog {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LogoutPromptTeacher dialog = new LogoutPromptTeacher();
	...
	public LogoutPromptTeacher() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TeacherPanel.getFrmTeacherPanel().dispose();
