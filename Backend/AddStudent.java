...
public class AddStudent extends JDialog {
        ...
        public AddStudent() {
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, addStudentHeading, 10, SpringLayout.NORTH,
                                contentPanel);
                sl_contentPanel.putConstraint(SpringLayout.WEST, addStudentHeading, 26, SpringLayout.WEST,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.WEST, studentFullNameTextField, 0, SpringLayout.WEST,
                                studentAgeTextField);
                sl_contentPanel.putConstraint(SpringLayout.EAST, studentAgeTextField, -37, SpringLayout.EAST,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1, 444, SpringLayout.NORTH,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.EAST, studentGroupTextField, -37, SpringLayout.EAST,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1_1_1_1, 209, SpringLayout.NORTH,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.WEST, levelComboBox, 0, SpringLayout.WEST,
                                studentFullNameTextField);
                sl_contentPanel.putConstraint(SpringLayout.SOUTH, levelComboBox, -377, SpringLayout.SOUTH,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, courseComboBox, -3, SpringLayout.NORTH,
                                lblNewLabel_1_1_1_1);
                sl_contentPanel.putConstraint(SpringLayout.WEST, courseComboBox, 0, SpringLayout.WEST,
                                studentFullNameTextField);
                sl_contentPanel.putConstraint(SpringLayout.SOUTH, courseComboBox, 27, SpringLayout.NORTH,
                                lblNewLabel_1_1_1_1);
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, addStudentButton, -58, SpringLayout.SOUTH,
                                contentPanel);
                sl_contentPanel.putConstraint(SpringLayout.WEST, addStudentButton, -221, SpringLayout.EAST,
                                contentPanel);
                sl_contentPanel.putConstraint(SpringLayout.SOUTH, addStudentButton, -15, SpringLayout.SOUTH,
                                contentPanel);
                sl_contentPanel.putConstraint(SpringLayout.EAST, addStudentButton, -150, SpringLayout.EAST,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.SOUTH, studentAddressTextField, -63, SpringLayout.NORTH,
                                studentAgeTextField);
                sl_contentPanel.putConstraint(SpringLayout.EAST, studentAddressTextField, -37, SpringLayout.EAST,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, semesterComboBox, 206, SpringLayout.NORTH,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.SOUTH, semesterComboBox, -27, SpringLayout.NORTH,
                                studentGroupTextField);
                sl_contentPanel.putConstraint(SpringLayout.EAST, semesterComboBox, -37, SpringLayout.EAST,
                                contentPanel);
                ...
                semesterComboBox
                                .setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(128, 128, 255),
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, studentAgeTextField, 2, SpringLayout.NORTH,
                                lblNewLabel_1_1_3);
                sl_contentPanel.putConstraint(SpringLayout.WEST, studentAgeTextField, 65, SpringLayout.EAST,
                                lblNewLabel_1_1_3);
                sl_contentPanel.putConstraint(SpringLayout.WEST, lblNewLabel_1_1_3, 0, SpringLayout.WEST,
                                addStudentHeading);
                sl_contentPanel.putConstraint(SpringLayout.SOUTH, lblNewLabel_1_1_3, -18, SpringLayout.NORTH,
                                lblNewLabel_1_1);
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, studentPhoneTextField, 2, SpringLayout.NORTH,
                                lblNewLabel_1_1);
                sl_contentPanel.putConstraint(SpringLayout.WEST, studentPhoneTextField, 20, SpringLayout.EAST,
                                lblNewLabel_1_1);
                sl_contentPanel.putConstraint(SpringLayout.EAST, studentPhoneTextField, -37, SpringLayout.EAST,
                                contentPanel);
                ...
                sl_contentPanel.putConstraint(SpringLayout.WEST, lblNewLabel_1_1_2_1, 0, SpringLayout.WEST,
                                addStudentHeading);
                ...
                sl_contentPanel.putConstraint(SpringLayout.NORTH, uniIdtextField, 0, SpringLayout.NORTH,
                                lblNewLabel_1_1_2_1);
