...
public class AddStudent extends JDialog {
	...
	private int studentLevelInt;
	private int studentSemesterInt;
	private int studentAgeInt;
	...
	public AddStudent() {
		...
		sl_contentPanel.putConstraint(SpringLayout.WEST, studentFullNameTextField, 17, SpringLayout.EAST, lblNewLabel_1_1_2);
		sl_contentPanel.putConstraint(SpringLayout.EAST, studentFullNameTextField, -37, SpringLayout.EAST, contentPanel);
		sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1_2, -2, SpringLayout.NORTH, studentFullNameTextField);
		sl_contentPanel.putConstraint(SpringLayout.NORTH, studentFullNameTextField, 30, SpringLayout.SOUTH, lblAddNewStudent);
		...
		sl_contentPanel.putConstraint(SpringLayout.WEST, studentAgeTextField, 0, SpringLayout.WEST, studentFullNameTextField);
		sl_contentPanel.putConstraint(SpringLayout.EAST, studentAgeTextField, 0, SpringLayout.EAST, studentFullNameTextField);
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, studentGroupTextField, 225, SpringLayout.NORTH, contentPanel);
		sl_contentPanel.putConstraint(SpringLayout.WEST, studentGroupTextField, 0, SpringLayout.WEST, studentFullNameTextField);
		sl_contentPanel.putConstraint(SpringLayout.EAST, studentGroupTextField, 0, SpringLayout.EAST, studentFullNameTextField);
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1, 78, SpringLayout.SOUTH, lblNewLabel_1_1_1_1);
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, studentAgeTextField, 24, SpringLayout.SOUTH, courseComboBox);
		...
		sl_contentPanel.putConstraint(SpringLayout.SOUTH, courseComboBox, -201, SpringLayout.SOUTH, contentPanel);
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, levelComboBox, 19, SpringLayout.SOUTH, studentFullNameTextField);
		sl_contentPanel.putConstraint(SpringLayout.WEST, levelComboBox, 0, SpringLayout.WEST, studentFullNameTextField);
		sl_contentPanel.putConstraint(SpringLayout.SOUTH, levelComboBox, -412, SpringLayout.SOUTH, contentPanel);
		sl_contentPanel.putConstraint(SpringLayout.EAST, levelComboBox, 0, SpringLayout.EAST, studentFullNameTextField);
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1_1_1_1_1, 223, SpringLayout.NORTH, contentPanel);
		sl_contentPanel.putConstraint(SpringLayout.WEST, lblNewLabel_1_1_1_1_1_1, 0, SpringLayout.WEST, lblAddNewStudent);
			...
			public void actionPerformed(ActionEvent e) {
				if(e.getActionCommand().equals("Add")) {
					...
					String insertQuery = "INSERT INTO `studentdetails` "
							...
							+ " VALUES (NULL, '"+studentName+"', '"+studentLevel+"', '"+studentSemester+"',"
		...
		sl_contentPanel.putConstraint(SpringLayout.EAST, btnCancel, 0, SpringLayout.EAST, studentFullNameTextField);
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, courseComboBox, 25, SpringLayout.SOUTH, studentAddressTextField);
		sl_contentPanel.putConstraint(SpringLayout.NORTH, studentAddressTextField, 25, SpringLayout.SOUTH, studentGroupTextField);
		sl_contentPanel.putConstraint(SpringLayout.SOUTH, studentAddressTextField, -256, SpringLayout.SOUTH, contentPanel);
		sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1_1, -2, SpringLayout.NORTH, studentAddressTextField);
		sl_contentPanel.putConstraint(SpringLayout.WEST, studentAddressTextField, 0, SpringLayout.WEST, studentFullNameTextField);
		sl_contentPanel.putConstraint(SpringLayout.EAST, studentAddressTextField, 0, SpringLayout.EAST, studentFullNameTextField);
		...
		sl_contentPanel.putConstraint(SpringLayout.WEST, lblNewLabel_1_1_1_2, 0, SpringLayout.WEST, lblAddNewStudent);
		...
		sl_contentPanel.putConstraint(SpringLayout.SOUTH, semesterComboBox, -360, SpringLayout.SOUTH, contentPanel);
		sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1_1_1_1, 3, SpringLayout.NORTH, semesterComboBox);
		sl_contentPanel.putConstraint(SpringLayout.NORTH, semesterComboBox, 22, SpringLayout.SOUTH, levelComboBox);
		sl_contentPanel.putConstraint(SpringLayout.WEST, semesterComboBox, 0, SpringLayout.WEST, studentFullNameTextField);
		sl_contentPanel.putConstraint(SpringLayout.EAST, semesterComboBox, 0, SpringLayout.EAST, studentFullNameTextField);
		semesterComboBox.setFont(new Font("Poppins", Font.PLAIN, 16));
		semesterComboBox.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(128, 128, 255), new Color(128, 128, 255),
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1_3, 0, SpringLayout.NORTH, studentAgeTextField);
		sl_contentPanel.putConstraint(SpringLayout.WEST, lblNewLabel_1_1_3, 0, SpringLayout.WEST, lblAddNewStudent);
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, studentPhoneTextField, 0, SpringLayout.NORTH, lblNewLabel_1_1);
		sl_contentPanel.putConstraint(SpringLayout.WEST, studentPhoneTextField, 0, SpringLayout.WEST, studentFullNameTextField);
		sl_contentPanel.putConstraint(SpringLayout.EAST, studentPhoneTextField, 343, SpringLayout.WEST, studentFullNameTextField);
