...
//	JComboBox levelComboBox = new JComboBox();
	...
	public AddModule() {
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, lblNewLabel_1_1_1_1, 34, SpringLayout.SOUTH, lblNewLabel_1_1_1);
		...
		sl_contentPanel.putConstraint(SpringLayout.NORTH, moduleLeaderComboBox, -5, SpringLayout.NORTH, lblNewLabel_1_1_1);
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getActionCommand().equals("Add")) {
					...
					String insertQuery = "INSERT INTO `moduledetails` "
							+ "(`moduleId`, `moduleName`, `moduleLeader`, `course`, `inLevel`)" + " VALUES ('" + moduleId + "', '"
							+ moduleName + "', '" + moduleLeaderFromComboBox + "', '" + courseFromComboBox + "','"+valueFromLevelComboBoxInt+"');";
					try {
